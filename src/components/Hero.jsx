...
import {principalHouse} from '@/images'
    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#F5247D" />
            <stop offset="1" stopColor="#F986B7" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              Creamos una nueva forma de encontrar tú casa IDEAL
            </h1>
            <p className="mt-6 text-lg text-gray-600">
            Aprovechamos el poder de la tecnología y lo juntamos con tus emociones para brindarle una
            experiencia inmersiva en el mercado inmobiliario. Nuestra misión es recomendar
            su hogar perfecto, adaptado a sus preferencias y necesidades únicas.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              {/* <AppStoreLink /> */}
              <Button
                href="https://bento.me/domo"
                variant="outline"
              >
                <PlayIcon className="h-6 w-6 flex-none" />
                <span className="ml-2.5">Redes Sociales</span>
              </Button>
            </div>
          </div>
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
            ...
            <div className="-mx-4 h-[448px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32">
              ...
              <Image
                src={principalHouse}
                alt="Alvar Aalto design style modern house"
